...
class TicTacToeEnv(gym.Env):
    ...
    def set_to_state(self,to_state=((0, 2, 0, 1, 1, 2, 0, 0, 0),'X')):
        self.board = list(to_state[0])
        self.mark = to_state[1]
        self.done = False
        return self._get_obs()
    ...
    def step(self, action):
        ...
        if status >= 0:
            ...
            if status in [1, 2]:
                ...
                reward = X_REWARD if self.mark == 'X' else O_REWARD
